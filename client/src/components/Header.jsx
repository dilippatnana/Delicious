        ...
        {user ? (
          <>
            <div className="relative cursor-pointer" onMouseEnter={() => { setIsMenu(true)}}>
              ...
              {isMenu && (
                <motion.div {...slideTop} onMouseLeave={() => { setIsMenu(false)}} className="w-44 px-6 py-4 bg-cardOverlay backdrop-blur-md rounded-md shadow-md absolute top-12 right-0 flex flex-col gap-4">
                <Link
