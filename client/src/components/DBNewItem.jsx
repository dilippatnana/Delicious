...
const DBNewItem = () => {
  ...
  const submitNewData = () => {
    ...
    console.log(data);
    console.log("inside submitNewData");
    ...
    <div className="flex items-center justify-center flex-col pt-6 px-24 w-full">
      <div className="border border-gray-300 rounded-md p-4 w-full flex flex-col items-center justify-center gap-4 ">
        ...
        <InputValueField
          ...
          stateFunc={setPrice}
        />
        <div className="w-full h-370 bg-cardOverlay border-2 border-dotted border-gray-300 shadow-md rounded-md cursor-pointer">
          {isLoading ? (
        ...
        <motion.button
          ...
          {...buttonClick}
          className="w-[5rem] py-2 rounded-md bg-red-400 text-primary hover:bg-red-500 cursor-pointer"
        >
          Save
        </motion.button>
      </div>
  ...
  return (
    <>
      <input
        ...
        className="w-full px-4 py-3 bg-cardOverlay shadow-md outline-none rounded-md border border-gray-300 focus:border-red-400"
        value={statevalue}
        onChange={(e) => {
